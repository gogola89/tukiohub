"""
TukioHub Base Settings
Django settings for TukioHub project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='tukiohub_db'),
        'USER': config('DB_USER', default='tukiohub_user'),
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'apps.users.authentication.DualUserJWTAuthentication',
    ),
